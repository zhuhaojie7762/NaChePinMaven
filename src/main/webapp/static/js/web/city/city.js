...
var allProvinces = Provinces_aeas.provinces;
var allCities = CITYData.cities;
var allAreas = Data_Areas.areas;
var allProId = null;
var cityIdAll = null;
...
function sendAllProvinceAjax() {
	allProvinces = Provinces_aeas.provinces;
	$("body").data("allProvinces", allProvinces);
	viewAllProvince(1);
}
function sendAllCitiesAjax() {
			$("body").data("CitysAll", CITYData.cities);
			viewAllHotCities();
}
function sendAllCountiesAjax()
 {
			$("body").data("allCountys", Data_Areas.areas);
}
