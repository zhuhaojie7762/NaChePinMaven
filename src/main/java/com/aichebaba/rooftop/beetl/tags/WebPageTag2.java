...
public class WebPageTag2 extends GeneralVarTagBinding {
    ...
    public void render() {
        ...
        html.append("<form class='pagination-form' action='").append(url).append("'><div class='sui-pagination ").append(style).append("'>")
                .append("<ul>")
