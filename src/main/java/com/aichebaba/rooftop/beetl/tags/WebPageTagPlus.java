...
public class WebPageTagPlus extends GeneralVarTagBinding {
    ...
    public void render() {
        ...
        html.append("<form class='pagination-form'><div class='sui-pagination ").append(style).append("'>")
                .append("<ul><li class='prev ").append(curNo == 1 ? "disabled" : "")
                .append("'><a>«上一页</a></li>");
        ...
        html.append("<li class='next ").append(curNo >= totalPage ? "disabled" : "")
                ...
                .append("<div><span>到<input type=\"text\" name='curNo' value=\"")
                .append(curNo)
                .append("\" class=\"page-num\"><input type='button' class=\"page-confirm\" value='确定' />")
                .append("页</span>").append("<span>共").append(totalPage).append("页")
                .append("</span></div>")
        .append("</div>");
        ...
        html.append("<input type=\"hidden\" name=\"curNo\" value=\"").append(curNo).append("\" />")
                ...
                .append("<input type='hidden' name='perSize' value='12' />")
                .append("</form>");
        try {
