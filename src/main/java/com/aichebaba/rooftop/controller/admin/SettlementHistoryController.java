...
@Controller
@Scope("prototype")
public class SettlementHistoryController extends BaseController {
    ...
    public void index() throws ParseException {
        ...
        PageList<MonthlyBill> pager = monthlyBillDao.findBills(month, code, name, phone, false, getPageParam());
        setAttr("pager", pager);
        render("history_list.html");
    }

    public void toDeal() throws ParseException {
        ...
        MonthlyBill bill = monthlyBillDao.getByPK(new MonthlyBill(sellerId, month));
        bill.setEndDay(new LocalDateTime(bill.getEndDay()).minusSeconds(1).toDate());
        Customer seller = customerService.getById(bill.getSellerId());
    ...
    public void deal() throws ParseException {
        ...
        monthlyBillDao.paid(bill, bill.getFinishPayment(), remark);
        ok("处理成功");
    }
