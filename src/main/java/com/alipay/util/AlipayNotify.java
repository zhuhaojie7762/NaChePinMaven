...
public class AlipayNotify {
    ...
    public static boolean verify(Map<String, String> params, AlipayConfig alipayConfig) {
        ...
        if (params.get("notify_id") != null) {
            ...
            responseTxt = verifyResponse(notifyId, alipayConfig.getPartner());
        }
        String sign = "";
        if (params.get("sign") != null) {
            sign = params.get("sign");
        }
        boolean isSign = getSignVeryfy(params, alipayConfig, sign);
...
//	    AlipayCore.logResult(sWord);
     ...
     * @return 生成的签名结果
     */
    private static boolean getSignVeryfy(Map<String, String> Params, AlipayConfig alipayConfig, String sign) {
